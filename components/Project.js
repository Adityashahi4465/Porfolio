                    ...
                    <div className="carousel-item relative float-left w-full ">
                        ...
                        <div className="carousel-caption rounded-lg pb-2 flex flex-col justify-center absolute text-center text-black font-bold">
                            ...
                            <h5 className='space-x-5 flex justify-center px-5 rounded-lg mb-2 drop-shadow-2xl'>
                                ...
                                <Link href={projectDetails[0].appUrl} target="_blank"><DiAndroid className='text-2xl md:text-4xl text-yellow-500 font-bold contrast-200' /></Link>
                            </h5>
                        </div>
                    </div>
                    <div className="carousel-item active relative float-left w-full">
                        ...
                        <div className="carousel-caption rounded-lg pb-2 flex flex-col justify-center absolute text-center text-black font-bold">
                            ...
                            <h5 className='space-x-5 flex justify-center px-5 rounded-lg mb-2'>
                                <Link href={projectDetails[1].gitUrl} target="_blank"><VscGithub className='text-2xl md:text-4xl text-blue-400 font-bold contrast-200' /></Link>
                                <Link href={projectDetails[1].webUrl} target="_blank"><BsGlobe className='text-2xl md:text-4xl  text-blue-400 font-bold contrast-200' /></Link>
                                <Link href={projectDetails[1].appUrl} target="_blank"><DiAndroid className='text-2xl md:text-4xl  text-blue-400 font-bold contrast-200' /></Link>
                            </h5>
                        </div>
                    </div>
                </div>
